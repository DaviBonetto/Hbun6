import React, { useState } from 'react';
    ...
    import { Trash2, Plus, GripVertical, Square, CheckSquare } from 'lucide-react';
        ...
        <div className="flex flex-col h-full animate-slide-up">
          ...
          <div className="flex-1 overflow-y-auto space-y-1 custom-scrollbar pr-2">
            ...
            {tasks.map((task, index) => (
              ...
              >
                {/* Drag Handle */}
                <div className="cursor-grab opacity-0 group-hover:opacity-20 hover:!opacity-100 transition-opacity">
                ...
                <div className="flex-1 min-w-0 flex items-center justify-between group/text">
                  ...
                  <div className="flex items-center gap-3">
                     ...
                     <button 
                        ...
                        className="opacity-0 group-hover:opacity-100 text-vesper-text hover:text-vesper-red transition-all"
                     >
                        <Trash2 size={12} />
                     </button>
                  </div>
